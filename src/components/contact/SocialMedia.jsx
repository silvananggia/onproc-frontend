    ...
    <section className="social-section">
      ...
      <div className="social-links">
        <div className="social-item">
          <a href="https://www.youtube.com/@brinindonesia" className="social-button" target="_blank" rel="noopener noreferrer">
            <img
        ...
        <div className="social-item">
          <a href="https://www.instagram.com/brin_indonesia" className="social-button" target="_blank" rel="noopener noreferrer">
            <img
        ...
        <div className="social-item">
          <a href="https://www.facebook.com/brin.indonesia" className="social-button" target="_blank" rel="noopener noreferrer">
            <img
        ...
        <div className="social-item">
          <a href="https://x.com/brin_indonesia" className="social-button" target="_blank" rel="noopener noreferrer">
            <img
      ...
      <style jsx>{`
        .social-section {
          margin: 24px var(--page-pad-x) var(--page-pad-y);
        }
        .social-title {
